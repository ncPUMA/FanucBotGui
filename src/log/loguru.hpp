...
#define VLOG_CALL_F(...)                                                               \
	VLOG_SCOPE_F(loguru::Verbosity_CALL, __VA_ARGS__)

#define VLOG_CALL \
	VLOG_SCOPE_F(loguru::Verbosity_CALL, __FUNCTION__)

#define LOG_VALUE(_x_, _printspec_) \
	VLOG_F(loguru::Verbosity_PARAM, #_x_ "=" _printspec_, _x_)
